                    ...
                    <div>
                        <div class="sliderHeading ">
                            <h2 style="font-size: 30px ;">SEO Training in Mohali – Learn From Certified Experts |
                                5Trainers</h2>
                            <h4 class="mt-3 "
                                style="color: #0a6da5; background-color:white; padding:20px; border-radius:8px">At
                                5Trainers, we offer the most practical and job-oriented SEO
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-xl-5 offset-xl-1 mt-5 mt-xl-0">
                ...
                <div class="registerstack"><a href="#" class="theme-btn mt-30 aos-init aos-animate" data-aos="fade-up"
                        data-aos-delay="200">Register Now<span><img src="landingpage/assets/image/icon/reply_arrow.png"
                                alt=""></span></a></div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="servicecol">
                                <div class="service-imag">
                                    <img src="landingpage/assets/image/course/digital-marketing.png" class="img-fluid"
                                ...
                                <div class="service-info">
                                    ...
                                    <ul>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Advanced On-Page SEO Optimization Techniques</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Deep Keyword Research & Competitor Analysis</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Advanced Off-Page SEO & High-Quality Link Building</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Technical SEO (Crawling, Indexing, Site Structure)</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            SEO Content Strategy & SERP-Focused Content Creation</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Google Search Console & Analytics for Performance Tracking</li>
                                    </ul>
                        ...
                        <div class="col-lg-6">
                            <div class="servicecol">
                                ...
                                <div class="service-info">
                                    ...
                                    <ul>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Title Tag, Meta Description & Header (H1–H6) Optimization</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Keyword Placement, Content Optimization & SEO-Friendly Formatting</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            URL Structure Optimization & Internal Linking Strategy</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Image Optimization (Alt Tags, Compression, Naming)</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            User Experience (UX), Mobile-Friendliness & Readability Improvements
                                        </li>
                                    </ul>
                        ...
                        <div class="col-lg-6">
                            <div class="servicecol">
                                ...
                                <div class="service-info">
                                    ...
                                    <ul>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Understanding Website Crawling, Indexing & Search Engine Behavior</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Optimizing Website Architecture, URL Structure & Internal Linking</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Improving Website Speed, Core Web Vitals & Mobile Performance</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Fixing Technical Issues Using Robots.txt, Sitemap & Canonical Tags</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Implementing Structured Data & Schema Markup for Better Visibility</li>
                                    </ul>
                                    <div class="sview"><a href="../onemonth.php" target="_blank" title="View More"><img
                                                src="landingpage/assets/image/icon/sview.png" alt=""></a>
                                    </div>
                                </div>
                            </div><!--/courseModules-->
                        </div><!--/col-->
                        <div class="col-lg-6">
                            <div class="servicecol">
                                ...
                                <div class="service-info">
                                    ...
                                    <ul>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            High-Quality Backlink Building Through Guest Posting & Outreach</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Authority Link Acquisition Using Business Listings & Profile Creation
                                        </li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Competitor Backlink Analysis & Strategy Planning</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Social Bookmarking, Blog Posting & Content Distribution</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Broken Link Building & Resource Page Link Opportunities</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Brand Mentions, PR Links & Reputation Building Techniques</li>
                                    </ul>
                        ...
                        <div class="col-lg-6">
                            <div class="servicecol">
                                ...
                                <div class="service-info">
                                    ...
                                    <ul>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Ensuring Mobile-Friendly & Responsive Website Design</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Improving Mobile Page Speed & Core Web Vitals Performance</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Optimizing Content Layout, Font Size & Touch-Friendly Navigation</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Implementing AMP (Accelerated Mobile Pages) Where Needed</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Fixing Mobile Usability Issues Using Google Search Console</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Enhancing Mobile User Experience for Better Engagement & Rankings</li>
                                    </ul>
                                    <div class="sview"><a href="#" title="View More"><img
                                                src="landingpage/assets/image/icon/sview.png" alt=""></a></div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="servicecol">
                                ...
                                <div class="service-info">
                                    ...
                                    <ul>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Setting Up & Optimizing Google Business Profile (GMB)</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Building Local Citations & Consistent NAP (Name, Address, Phone) Details
                                        </li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Optimizing Website for Local Keywords & Location-Based Content</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Collecting & Managing Online Reviews for Better Local Ranking</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Creating Local Backlinks Through Directories & Local Outreach</li>
                                        <li><img src="assets/image/icon/bulb-blue.png" alt="icon" class="footer-icon">
                                            Tracking Local Search Performance Using Maps & Local SEO Tools</li>
                                    </ul>
                                    <div class="sview"><a href="#" title="View More"><img
                                                src="landingpage/assets/image/icon/sview.png" alt=""></a></div>
                                </div>
...
<section class="contaianer-fluid pt pb skill-cover">
    <div class="cutom-container width80">
        ...
        <div class="row mt-80">
            ...
            <div class="col-6 col-md-2 col-lg-2">
                <div class="placementbox" data-aos="fade-up" data-aos-duration="1000">
                    <div class=""><img src="landingpage/assets/image/landing-page/placement/Cisco_logo_blue.webp" alt=""
                            class="img-fluid"></div>
                </div>
            </div><!--/col-->
            <div class="col-6 col-md-2 col-lg-2">
            ...
            <div class="col-6 col-md-2 col-lg-2">
                <div class="placementbox" data-aos="fade-up" data-aos-duration="1000">
                    <div class=""><img src="landingpage/assets/image/landing-page/placement/Autodesk_Logo.webp" alt=""
                            class="img-fluid"></div>
                </div>
            </div><!--/col-->
            <div class="col-6 col-md-2 col-lg-2">
                <div class="placementbox" data-aos="fade-up" data-aos-duration="1000">
                    <div class=""><img src="landingpage/assets/image/landing-page/placement/Adobe_Corporate_logo.webp"
...
<!--  -->
<section class="py-5 slider text-white text-center" style="background-color: #0a6da5;">
    <div class="container">
