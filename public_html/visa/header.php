...
<head>
    ...
    <title>
        <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : '5Trainers Visa Consultancy | Immigration & Study'; ?>
    </title>
    <meta name="description"
        content="<?php echo isset($pageDescription) ? htmlspecialchars($pageDescription) : '5Trainers Visa Consultancy – IELTS, Immigration, PTE, Visa, Work Permit & PR Centre in Mohali, Punjab (India).'; ?>">
        ...
        <div class="container">
            <div class="top-nav">
                ...
                <a href="index.php" class="brand" aria-label="5Trainers Visa Consultancy Home">
                    <div class="brand-logo">
                        <!-- <img src="assets/img/5trainers-logo.png" alt="5Trainers Visa Consultancy logo"> -->
                        <img src="assets/img/visa-5trainers.png" alt="5Trainers Visa Consultancy logo">
                    </div>
                </a>
                ...
                <nav class="main-menu">
                    ...
                    <a href="registration.php"
                        class="<?php echo ($currentPage === 'registration') ? 'active' : ''; ?>">Registration</a>

                    <!-- Services Dropdown -->
                    <div
                        class="nav-dropdown <?php echo (strpos($currentPage, 'service') === 0 || $currentPage === 'services') ? 'active' : ''; ?>">
                        <a href="services.php" class="dropdown-toggle">
                            Services <i class="fas fa-chevron-down"></i>
                        </a>
                        <div class="dropdown-menu">
                            <a href="services-ielts.php"
                                class="<?php echo ($currentPage === 'service-ielts') ? 'active' : ''; ?>">IELTS
                                (Academic/General)</a>
                            <a href="services-pte.php"
                                class="<?php echo ($currentPage === 'service-pte') ? 'active' : ''; ?>">Pearson Test of
                                English</a>
                            <a href="services-general-english.php"
                                class="<?php echo ($currentPage === 'service-general-english') ? 'active' : ''; ?>">General
                                English</a>
                            <a href="services-study-visa.php"
                                class="<?php echo ($currentPage === 'service-study-visa') ? 'active' : ''; ?>">Study
                                Visa</a>
                            <a href="services-tourist-visa.php"
                                class="<?php echo ($currentPage === 'service-tourist-visa') ? 'active' : ''; ?>">Tourist
                                Visa</a>
                            <a href="services-spouse-visa.php"
                                class="<?php echo ($currentPage === 'service-spouse') ? 'active' : ''; ?>">Spouse
                                Visa</a>
                        </div>
                    </div>
                    ...
                    <a href="blog.php" class="<?php echo ($currentPage === 'blog') ? 'active' : ''; ?>">Blog &amp;
                        Results</a>
                    <a href="contact.php"
