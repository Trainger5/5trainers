                ...
                <div class="intro-details">
                        <div >
                            ...
                            <p class="coDetail">Join the best digital marketing institute in Delhi and master SEO,
                                ...
                                projects.</p>
                            <!--for Both Freshers &-->
                            <h4 class="main-heading">Learn Skills That Grow Careers & Businesses</h4>
                        </div><!--/slider text-->
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Learn to rank websites on Google. Includes keyword research, on-page/off-page SEO, technical
                            SEO, and local SEO with live projects.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Master brand growth on Facebook, Instagram, LinkedIn, and YouTube. Cover content creation,
                            paid campaigns, audience growth, and analytics.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Learn to create and manage paid campaigns on Google & social media. Focus on targeting, ad
            ...
            <div class="col-md-6 col-lg-4 mt-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Create compelling content that attracts and converts—blogs, website copy, social posts, and
                            basic SEO-friendly copywriting.
                        </p>
            ...
            <div class="col-md-6 col-lg-4 mt-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Use Google Analytics, Search Console, and modern AI-powered marketing tools to track
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3">
                    ...
                    <p class="text-muted">
                        Our trainers are practicing digital marketers who simplify complex concepts and share real
                        industry insights.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3">
                    ...
                    <p class="text-muted"> Work on live websites, ad campaigns, SEO projects, and social media
                        strategies throughout the course.</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3">
                    ...
                    <p class="text-muted">
                        No prior experience needed. We start from the basics and progress systematically to advanced
                        strategies.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3">
                    ...
                    <p class="text-muted"> Receive guidance on interview preparation, resume building, and launching
                        your freelancing journey or client management.</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3">
                    ...
                    <p class="text-muted">
                        Train under experts who handle live digital marketing projects daily—no outdated or purely
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3">
                    ...
                    <p class="text-muted">
                        Gain confidence by working on real tools—from SEO audits to Google Ads campaigns—using live
                        projects.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3">
                    ...
                    <p class="text-muted">
                        Get realistic advice on job roles, salary expectations, and freelancing opportunities—no false
                        promises.
                    </p>
                </div>
            </div>
            ...
            <div class="colof col-sm-6 col-lg-6">
                <div class="features-list darkfeature">
                    <div class="li">
                        ...
                        <p class="text-white">Digital marketing skills are highly sought-after across Delhi’s thriving
                            IT sector, startups, marketing agencies, and businesses of all sizes.</p>
                    </div>
                </div>
            </div><!--/col-->
            <div class="colof col-sm-6 col-lg-6">
...
<section class="py-5 slider text-white text-center" style="background: #0f79be;">
    <div class="container">
        ...
        <p class="lead mb-4 text-white text-center">
            Join 5Trainers – the leading digital marketing institute in Delhi – and acquire skills that drive
            professional and financial growth.
        </p>
        <p class="lead mb-4 text-white text-center">
            Contact us today to enroll in our Digital Marketing Training in Delhi and take your first step toward a
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="accordion rpt mt-80">
                    <div class="box active">
                        ...
                        <div class="content">
                            Digital marketing involves promoting products or services using online channels like Google,
                            social media, email, websites, and paid advertisements.
                        </div>
                    </div>
                    <div class="box">
                        <div class="label">2. Who can join the digital marketing course in Delhi?</div>
                        <div class="content">
                            Anyone interested—students, freshers, working professionals, business owners, freelancers,
                            or those looking to switch careers.
                        </div>
                    </div>
                    <div class="box">
                        <div class="label">3. Is this course suitable for beginners?</div>
                        <div class="content">Absolutely. The training is structured from the ground up, making it ideal
                            for beginners.</div>
                    </div>
                    <div class="box">
                        <div class="label">4. What topics are covered?</div>
                        <div class="content">
                            The course covers SEO, Social Media Marketing, Google Ads, Content Marketing, Email
                    ...
                    <div class="box">
                        ...
                        <div class="content">
                            Yes, it is heavily focused on practical, hands-on experience with live projects and real
                    ...
                    <div class="box">
                        ...
                        <div class="content">Yes. We provide dedicated career guidance, interview prep, and freelancing
                            launch support.
                        </div>
                    </div>
                    <div class="box">
                        <div class="label">8. Why choose 5Trainers in Delhi?</div>
                        <div class="content">For our experienced trainers, practical curriculum, small batch sizes,
                            competitive fees, and industry-relevant training.
                        </div>
                    </div>
                    <div class="box">
