            ...
            <div class="col-12 col-xl-7">
                <div class="intro-details">
                    <div>
                        ...
                        <h4 class="main-heading">Build
                            In-Demand Digital Skills for Today’s Opportunities</h4>
                    </div><!--/slider text-->
                    <div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Master on-page, off-page, technical, and local SEO. Learn keyword research, competitor
                            analysis, and perform live website optimization for local businesses.
                        </p>
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            video content, SEO-optimized copywriting, and content calendar management.
                        </p>
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            content creation, ad optimization, and data analysis.
                        </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 digital-card-new">
                    ...
                    <p class="text-muted"> Execute real SEO audits, manage Google Ads campaigns, run social media
                        strategies, and create content for actual projects during your training.</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 Digital-card">
                    ...
                    <p class="text-muted">
                        No prior technical knowledge required. We start with fundamentals and progress step-by-step to
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 digital-card-new">
                    ...
                    <p class="text-muted"> Receive dedicated guidance for resume building, interview preparation,
                        freelancing setup, and job placement assistance in Ambala and remote opportunities.</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 Digital-card">
                    ...
                    <p class="text-muted">
                        Curriculum is updated with current algorithm changes and successful marketing strategies—no
                        outdated theoretical concepts.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 digital-card-new">
                    ...
                    <p class="text-muted">
                        Gain proficiency in Google Analytics 4, Google Ads, Meta Business Suite, Canva, SEO tools, and
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 Digital-card">
                    ...
                    <p class="text-muted">
                        We break down complex digital concepts into easy-to-understand, actionable steps perfect for
                        beginners.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 Digital-card">
                    ...
                    <p class="text-muted">
                        Get transparent advice about Ambala's job market, remote work opportunities, freelancing
                        potential, and realistic salary expectations.
                    </p>
                </div>
            </div>
            ...
            <div class="colof col-sm-6 col-lg-6">
                <div class="features-list darkfeature">
                    <div class="li">
                        ...
                        <p class="text-white">Ambala’s growing commercial environment offers opportunities in local
                            businesses, nearby industrial units, and access to remote positions with companies across
                            India.</p>
                    </div>
                </div>
            </div><!--/col-->
                    ...
                    <div class="li">
                        ...
                        <ul class="p " style="padding: 0px;">
                            ...
                            <li class="text-white">Job seekers and professionals aiming to transition into high-growth
                                digital roles</li>
                            <li class="text-white">Local business owners, entrepreneurs, and shopkeepers wanting to grow
                                their business online</li>
                            <li class="text-white">Freelancers, bloggers, and content creators seeking to monetize their
                                skills </li>
                            <li class="text-white">Working professionals in marketing, sales, or IT looking to upgrade
                                their digital expertise</li>
                        </ul>
...
<section class="py-5 slider text-white text-center" style="background: #0f79be;">
    <div class="container">
        ...
        <p class="lead mb-4 text-white text-center">
            Join 5Trainers—Ambala's most trusted digital marketing institute—and gain the practical skills and
            confidence to excel in the digital domain.
        </p>
        <p class="lead mb-4 text-white text-center">
                ...
                <div class="accordion rpt mt-80">
                    ...
                    <div class="box">
                        ...
                        <div class="content">Yes, we provide complete placement support, including interview
                            preparation, resume workshops, and connecting you with job opportunities in Ambala and
                            remote positions.
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="content">For our industry-expert trainers, completely practical approach, strong
                            placement support, affordable fees, and proven track record of student success in Ambala.
                        </div>
                    </div>
                    <div class="box">
                    ...
                    <div class="box">
                        ...
                        <div class="content">You can call our Ambala center directly, visit our website, or come to our
