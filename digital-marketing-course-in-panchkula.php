                ...
                <div class="intro-details">
                    <div>
                        ...
                        <div class="sliderHeading mb-20">
                            ...
                            <h2 class="heading-main">Digital Marketing Course in Panchkula</h2>
                            <h4 class="mt-4 main-heading">Digital Marketing Course in Panchkula – Learn Practically
                                with 100% Placement Support</h4>
                        </div>
                        ...
                        <h4 class="main-heading">Build In-Demand Digital Skills for Today’s Opportunities</h4>
                    </div><!--/slider text-->
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Create and manage marketing strategies for Facebook, Instagram, LinkedIn, and YouTube. Learn
            ...
            <div class="col-md-6 col-lg-4 mt-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Learn blog writing, landing page content, video marketing, and SEO-friendly content
                            creation.
                        </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 p-3 Digital-card">
                    ...
                    <p class="text-muted">
                        Get transparent advice about Panchkula's job market, remote work opportunities, freelancing
            ...
            <div class="colof col-sm-6 col-lg-6">
                <div class="features-list darkfeature">
                    <div class="li">
                        ...
                        <p class="text-white">With opportunities available in Panchkula, Chandigarh, Mohali, and remote
                            jobs, digital marketing offers long-term career growth.</p>
                    </div>
                </div>
            </div><!--/col-->
            <div class="colof col-sm-6 col-lg-6">
...
<section class="py-5 slider text-white text-center" style="background: #0f79be;">
    <div class="container">
        ...
        <p class="lead mb-4 text-white text-center">
            Enroll in 5Trainers, the trusted institute for a Digital Marketing Course in Panchkula, and take the first
            step toward a successful digital career.
        </p>
        <p class="lead mb-4 text-white text-center">
                ...
                <div class="accordion rpt mt-80">
                    ...
                    <div class="box">
                        ...
                        <div class="content">Yes, we provide complete placement support, including interview
                            preparation, resume workshops, and connecting you with job opportunities in Panchkula
                        </div>
                        <div class="box">
                            ...
                            <div class="content">For our industry-expert trainers, completely practical approach, strong
                                placement support, affordable fees, and proven track record of student success in
                                Panchkula.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">9. What is the duration and schedule of the course?</div>
                            <div class="content">We offer flexible weekday and weekend batches to suit different
                                schedules. The duration typically ranges from 3 to 4 months. Contact us for current
                                batch details.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">10. How do I enroll or get more information?</div>
                            <div class="content">You can call our Panchkula center directly, visit our website, or come
                                to our institute for a detailed counseling session and course overview.
                            </div>
                        </div>
                    </div>
                    <!--/accordion-->
